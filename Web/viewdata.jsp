...
++temp;
%>
<tr><TH><H4><%=temp%><tH><H4><%=rs1.getString(2)%><tH><H4><%=rs1.getS
tring(3)%><tH><H4><%=rs1.getString(4)%><tH><H4><H4><%=rs1.getString(5)%><tH><H
4><H4><%=rs1.getString(6)%><tH><H4><H4><%=rs1.getString(7)%>
<%
}}
catch(Exception e1)
{
